...
- 2026-07-27: Planning is an official optional module. It retains `.plan/` for initial local compatibility, treats GitHub as transitional, retires official Linear support, and uses review-first Brain memory proposals.
