...
- Current branch: `codex/planning-public-domain-boundary`
...
- 2026-07-31: Phase 4's third slice exposes the stdlib-only storage-neutral domain at `github.com/JimmyMcBride/brain/planning`. A canonical external-package test locks the reviewed exports and forbids `go.mod` replacements; application, local adapter, conformance, and CLI behavior remain internal. The next slice captures and migrates workspace/query/check/roadmap behavior.
