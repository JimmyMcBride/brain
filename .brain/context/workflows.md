...
- 2026-07-29: Local Planning verification must cover `internal/planning/application`, `internal/official/planning`, `internal/official/planning/local`, and `cmd`; run focused tests, affected-package race/vet, whole-repo test/build, and `plan check`.
