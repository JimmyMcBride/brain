...
Track the current planning and brainstorming model and the next iteration points.


## Acceptance Criteria

- [ ] Planning stays attached to the current project
- [ ] Brainstorms and work items remain linkable
