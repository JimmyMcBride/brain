...
Track the remaining cleanup work around project-local terminology, workspace boundaries, and migration ergonomics.


## Acceptance Criteria

- [ ] Remove old-system user-facing language
- [ ] Keep tests green during cleanup
