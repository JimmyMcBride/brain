...
Publications containing at least five specs must include a workspace decision before provider inspection. Plans order the group before artifacts and relationships and the workspace decision last. Existing stable identities classify as reuse or unchanged; conflicting, missing, foreign-provider, or malformed identities fail closed. Completed group and non-skipped workspace actions require stable provider evidence, including no-op reruns.
