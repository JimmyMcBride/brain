...
- 2026-07-27: Planning migration supports local, GitHub, and GitHub-hybrid sources only. Brain Planning never imports or implements Linear integration; legacy Linear workspaces receive standalone Plan migration guidance. Planning may propose—but not silently write—durable Brain memory.
