...
func TestPublicPlanningApplicationExportSurface(t *testing.T) {
	...
	want := []string{
		...
		"PublicationArtifactAction", "PublicationGroup", "PublicationGroupAction", "PublicationInspectRequest", "PublicationPlan", "PublicationRelationship",
		"PublicationRelationshipAction", "PublicationRelationshipContains", "PublicationRelationshipDependsOn",
		"PublicationRelationshipKind", "PublicationResult", "PublicationSnapshot", "PublicationTarget", "PublicationWorkspaceAction", "PublicationWorkspaceChoice",
		"PublicationWorkspaceConnect", "PublicationWorkspaceCreate", "PublicationWorkspaceDecision", "PublicationWorkspaceSkip", "ReconciliationEvidence", "ReconciliationPlan", "ReconciliationResult",
